...
![icon](../image/eitsupi.jpg){fig-align="center" width="300" height="300"}
...
数十分かけて読み込んでいたCSVファイルをParquetに置換してみたら数分で読めるようになったのでその際に調べたこと中心。
...
- RockerプロジェクトのDockerでは`rocker/tidyverse`にインストールされている（のでこのスライド内のサンプルコードは`rocker/tidyverse`で動くはず）。
- ソースインストールには恐ろしい時間がかかることに注意！
