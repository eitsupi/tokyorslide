...
[^0.8.0]: 現在最新の0.8.0ではオートコンプリートが壊れている模様 ([duckdb/duckdb#7564](https://github.com/duckdb/duckdb/issues/7564))
...
DuckDBのリポジトリに置かれているいつものParquet[^parquet]をダウンロードします（※手抜き）
