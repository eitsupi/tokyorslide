...
## [pkgdown](https://pkgdown.r-lib.org/) (1/2)
...
## [pkgdown](https://pkgdown.r-lib.org/) (2/2)
...
また、`pkgdown`上のRコードブロック内では、それぞれの関数がリンクになる（上の画像の`select`）ので、例の中の知らない関数についてもすぐに調べられます。
